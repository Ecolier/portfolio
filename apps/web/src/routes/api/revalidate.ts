  ...
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        // With CDN-based ISR, on-demand revalidation purges the CDN cache.
        // Replace with your CDN's purge API (Cloudflare, Vercel, etc.)
        // For now, log the paths that would be purged.
        console.log("[revalidate] Purging paths:", paths);
