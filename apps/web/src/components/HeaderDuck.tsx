...
const HeaderDuck = forwardRef<HeaderDuckHandle, { className?: string }>(
  function HeaderDuck({ className }, ref) {
    ...
    const wingFront = () => svgPart("wing-front", "duck-wing-front", "wing");
    const wingBack = () => svgPart("wing-back", "duck-wing-back");
    const eye = () => svgPart("eye", "duck-eye");
    const beak = () => svgPart("beak", "duck-beak");
    const legBack = () => svgPart("leg-back", "pillar-back");
    const legFront = () => svgPart("leg-front", "pillar-front");
    const foot = () => svgPart("foot", "duck-foot", "foot-front");
    const body = () => svgPart("body", "duck-body");
