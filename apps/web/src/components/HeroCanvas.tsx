...
export default function HeroCanvas({
  ...
  useEffect(() => {
    ...
    function onThemeSnap(e: Event) {
      ...
      current.bg[1] = p.bg[1];
      current.bg[2] = p.bg[2];
      current.line[0] = p.line[0];
      current.line[1] = p.line[1];
      current.line[2] = p.line[2];
      current.particle[0] = p.particle[0];
      current.particle[1] = p.particle[1];
      current.particle[2] = p.particle[2];
